...
export default {
  ...
  config: {
    ...
    'pages/collagedetails/main','pages/store/main','pages/storeruzhu/main','pages/shoplist/main',
    ...
    'pages/dingdan2/main','pages/fengrungood/main','pages/map/main','pages/tuihuo/main'
    ],
    window: {
